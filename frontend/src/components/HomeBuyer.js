...
export default function HomeBuyer() {
  ...
  return (
    <div className="container">
      ...
      <a href="/buyerhome/myorders">
        <Button variant="success">My Orders</Button>
      </a>
      {/* Adding a cart image  */}
      <div style={{ float: "right" }}>
        <a href="/buyer/view/cart">
          {" "}
          ...
          {items.map((item) => (
            ...
            >
              ...
              >
                ...
                <Rater
                  total={5}
                  rating={avgRatings[item.ProductId]}
                  interactive={false}
                  style={{ fontSize: "30px" }}
                />
                <button
                  ...
                  onClick={() => {
                    window.location.replace(
                      `http://localhost:3000/buyer/view/item/${item.ProductId}`
                    );
                  }}
                >
                  View
