...
export default function ManageBuyers() {
  ...
  useEffect(() => {
    ...
    function getBuyers() {
      axios
        .get("http://localhost:8070/buyerH/")
        .then((res) => {
          setBuyers(res.data);
        })
        .catch((err) => {
              ...
              <tr>
                  ...
                  <button
                    ...
                    onClick={() => {
                      window.location.replace(
                        `http://localhost:3000/adminhome/managebuyers/view/${buyer.email}`
                      );
                    }}
                  >
                ...
                <td>
                  <button
                    ...
                    onClick={() => {
                      window.location.replace(
                        `http://localhost:3000/adminhome/managebuyers/update/${buyer.email}`
                      );
                    }}
                  >
