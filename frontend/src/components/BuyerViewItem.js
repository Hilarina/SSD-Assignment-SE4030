...
export default function BuyerViewItem() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:8070/buyerH/get/item/${id}`)
      .then((res) => {
    ...
    axios
      .get(`http://localhost:8071/rate/get/${buyerEmail}/${id}`)
      .then((res) => {
        console.log(res.data);
  ...
  function rateProduct(value) {
    ...
    if (rate === 0) {
      ...
      axios.post("http://localhost:8071/rate/add", newRate, {
        headers: {
          "CSRF-Token": csrfToken,
        },
        withCredentials: true,
      ...
      axios.put("http://localhost:8071/rate/update", newRate, {
        headers: {
          "CSRF-Token": csrfToken,
        },
        withCredentials: true,
