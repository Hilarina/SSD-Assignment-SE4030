...
import OAuthMiddlewareBuyer from "./components/OAuthMiddlewareBuyer";
import OAuthMiddlewareSeller from "./components/OAuthMiddlewareSeller";
  ...
  return (
    ...
    >
      <Router>
        ...
        <Route path="/buyeroauth" exact component={OAuthMiddlewareBuyer} />
        <Route path="/selleroauth" exact component={OAuthMiddlewareSeller} />
        ...
        <Route
          path="/buyerhome/myorders/:orderRef"
          exact
        ...
        <Route
          path="/adminhome/managesellers"
          exact
          component={ManageSellers}
        />
        <Route path="/adminhome/manageorders" exact component={ManageOrders} />
        <Route
          path="/adminhome/manageorders/:orderRef"
          exact
          component={SingleOrderAdmin}
        />

        <Route
          path="/adminhome/managesellers/add"
          exact
          component={AddSeller}
        />

        <Route
          path="/adminhome/managebuyers/view/:email"
          exact
          component={ViewBuyer}
        />
        <Route
          path="/adminhome/managebuyers/update/:paramemail"
          exact
          component={UpdateBuyer}
        />

        <Route
          path="/adminhome/managesellers/view/:email"
          exact
          component={ViewSeller}
        />
        <Route
          path="/adminhome/managesellers/update/:paramemail"
          exact
        ...
        <Route
          path="/sellerhome/item/delete/:id"
          exact
          componenet={DeleteItem}
        ></Route>
        <Route
          path="/sellerhome/item/update/:id"
          exact
          component={UpdateItem}
        ></Route>
        <Route
          path="/sellerhome/item/get/:id"
          exact
          component={SingleItem}
        ></Route>
        <Route path="/sellerhome/delivery" exact component={DeliveryRequests} />
        <Route
          path="/sellerhome/delivery/:orderRef"
          exact
          component={SingleOrderSeller}
        />
      </Router>
    </PayPalScriptProvider>
  );
